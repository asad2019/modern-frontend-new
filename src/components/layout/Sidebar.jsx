...
const Sidebar = () => {
    ...
    const allNavItems = [
      ...
      { to: '/brokers', icon: UserCircle, label: 'Brokers', perm: 'brokers' },
      { to: '/suppliers', icon: Building, label: 'Suppliers', perm: 'all' },
      { to: '/finishing-units', icon: SprayCan, label: 'Finishing Units', perm: 'all' },
      { to: '/sizing', icon: GitBranch, label: 'Sizing Accounts', perm: 'sizing-accounts' },
      ...
      { to: '/po', icon: FileText, label: 'PO', perm: 'po' },
      { to: '/product', icon: Package, label: 'Product', perm: 'product' },
      { to: '/shipmentcodes', icon: Truck, label: 'Shipment Codes', perm: 'shipmentcodes' },
      { to: '/shipments', icon: Truck, label: 'Shipments', perm: 'shipments' },
